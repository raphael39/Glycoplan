...
3. The third tab is about recipes that are mainly based on green coded food.
...
2. Run `npm install` 
3. Run a simulator device from XCode, Android Studio or download the "Expo Client" app on your phone.
4. Run `npm start`.
5. Run 'i' or 'a' for ios or android or scan the QR Code with your phone
